...
export const writingStyles: WritingStyle[] = [
  {
    ...
    description: 'A style focused on artistic merit, character development, and thematic depth.',
    characteristics: [
  ...
  {
    name: 'Fantasy',
    description: 'A style that incorporates magical and supernatural elements into the narrative.',
    characteristics: [
      'World-building',
      'Magic systems',
      'Heroic journeys',
  ...
  },
  {
    ...
    description: 'A style that explores scientific and technological concepts in futuristic settings.',
    characteristics: [
      'Scientific accuracy',
      'Futuristic settings',
  ...
  },
  {
    ...
    description: 'A style focused on suspense, intrigue, and solving puzzles or crimes.',
    characteristics: [
      'Suspense building',
      'Clue placement',
      'Plot twists',
  ...
  {
    name: 'Romance',
    description: 'A style focused on romantic relationships and emotional development.',
    characteristics: [
      'Character chemistry',
      'Emotional depth',
  ...
  },
  {
    ...
    description: 'Blends historical facts with fictional narratives, bringing past eras to life through compelling characters and events.',
    characteristics: [
  ...
  {
    name: 'Horror',
    description: 'Creates fear, dread, and suspense through supernatural elements, psychological terror, or physical threats.',
    characteristics: [
  ...
  {
    name: 'Young Adult',
    description: 'Targets teenage readers with coming-of-age stories, exploring themes of identity, relationships, and personal growth.',
    characteristics: [
  ...
  },
  {
    ...
    description: 'Blends realistic settings with magical elements, treating the supernatural as a natural part of everyday life.',
    characteristics: [
